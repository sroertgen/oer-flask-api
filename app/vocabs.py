    ...
    def get_vocab(cls, name):
        ...
        for item in y:
            try:
                ...
                label_en = next(
                    (item for item in item['http://www.w3.org/2004/02/skos/core#prefLabel'] if item['@language'] in ["en", "en-US"]), None)
            ...
            try:
                ...
                description_en = next(
                    (item for item in item['http://www.w3.org/2004/02/skos/core#definition'] if item['@language'] in ["en", "en-US"]), None)
